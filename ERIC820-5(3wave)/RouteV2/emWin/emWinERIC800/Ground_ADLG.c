...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  break;	
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		...
		VoltageTemp=SDSuddentAlarmData->RMSValue[0][1];	
		//VoltageTemp=Voltage;	
    ...
    TEXT_SetTextColor(hItem, GUI_GREEN);
		...
		VoltageTemp=SDSuddentAlarmData->RMSValue[1][1];	
	//	VoltageTemp=Voltage;
    ...
    TEXT_SetTextColor(hItem, GUI_RED);
		...
		VoltageTemp=SDSuddentAlarmData->RMSValue[2][1];	
		//VoltageTemp=Voltage;
    ...
    TEXT_SetTextColor(hItem, GUI_WHITE);
		*/
		VoltageTemp=SDSuddentAlarmData->RMSValue[3][1];	
		//VoltageTemp=Voltage;
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		...
		VoltageTemp=SDSuddentAlarmData->RMSValue[4][1];	
		//VoltageTemp=Voltage;
    ...
    TEXT_SetTextColor(hItem, GUI_GREEN);
		...
		VoltageTemp=SDSuddentAlarmData->RMSValue[5][1];	
		//VoltageTemp=Voltage;
    ...
    TEXT_SetTextColor(hItem, GUI_RED);
		...
		VoltageTemp=SDSuddentAlarmData->RMSValue[6][1];	
		//VoltageTemp=Voltage;
    ...
    TEXT_SetTextColor(hItem, GUI_WHITE);
		*/
		VoltageTemp=SDSuddentAlarmData->RMSValue[7][1];	
		//VoltageTemp=Voltage;
