...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { BUTTON_CreateIndirect, "Voltag Limit Set", ID_BUTTON_10, 0, 265, 150, 39, 0, 0x0, 0 },
	...
	#endif
  { DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_0, 280, 100, 120, 30, 0, 0x0, 0 },
  { DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_1, 580, 100, 200, 30, 0, 0x0, 0 },
	{ DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_2, 640, 180, 140, 30, 0, 0x0, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_0, 280, 300, 120, 35, 0, 0x64, 0 },
  { BUTTON_CreateIndirect, "Button", ID_BUTTON_15, 580, 300, 120, 35, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
   ...
   // GUI_SetFont(GUI_FONT_20B_ASCII);
		GUI_SetFont(&XBF_Font24);
    GUI_DispStringAt("柜体编号",175,100);

    GUI_DispStringAt("位置",520,100);

    GUI_DispStringAt("ID号",195,300);
		
		GUI_DispStringAt("保护器类型",520,180);
