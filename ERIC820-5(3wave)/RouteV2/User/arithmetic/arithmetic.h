...
#define ibubblebufSIZE	16
extern bubblestrcut bubblebuf[8][ibubblebufSIZE];
...
extern void SelRouteCalTask(void);
extern void bubbleCal(bubblestrcut *buf,uint8_t buf_len);
#endif
/*----------------------------end---------------------------*/
