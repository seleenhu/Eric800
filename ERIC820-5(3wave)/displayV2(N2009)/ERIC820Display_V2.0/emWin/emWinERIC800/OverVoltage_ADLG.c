...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {
    ...
    //TEXT_SetTextColor(hItem, GUI_MAKE_COLOR(0x00000000));
		...
		year = ModuleComFaultbuf->Tim.year;
		month = ModuleComFaultbuf->Tim.month;
		day = ModuleComFaultbuf->Tim.day;
		hour = ModuleComFaultbuf->Tim.hour;
		minute = ModuleComFaultbuf->Tim.minute;
		second = ModuleComFaultbuf->Tim.second;		
		us = ModuleComFaultbuf->Tim.us;
    us=us/1000;	
    ...
    //
		...
		PhaseFlag = ModuleComFaultbuf->ValueFlag;
    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_1);
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		...
		VoltageTemp = ModuleComFaultbuf->RMSValue[0][1];
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		...
		//VoltageTemp=Voltage/100.0;
		VoltageTemp = ModuleComFaultbuf->RMSValue[1][1];
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		...
		//VoltageTemp=Voltage/100.0;
		VoltageTemp = ModuleComFaultbuf->RMSValue[2][1];
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		*/
		...
		VoltageTemp = ModuleComFaultbuf->RMSValue[3][1];
		 ...
		 for(i=0;i<12;i++)//中心点在第10周期
			{
				...
				while(1)
				{
					...
					Wave[0]=ModuleComFaultbuf->Wave[0][i*64+n];
					Wave[1]=ModuleComFaultbuf->Wave[1][i*64+n];
					Wave[2]=ModuleComFaultbuf->Wave[2][i*64+n];
				
					
					VoltageTemp=Wave[0]/(Scale*ModuleComFaultbuf->fftratio[0])+90;
					GRAPH_DATA_YT_AddValue(ahDataUA,Wave[0]/(Scale*ModuleComFaultbuf->fftratio[0])+100);
				
					GRAPH_DATA_YT_AddValue(ahDataUB,Wave[1]/(Scale*ModuleComFaultbuf->fftratio[1])+100);
				
					GRAPH_DATA_YT_AddValue(ahDataUC,Wave[2]/(Scale*ModuleComFaultbuf->fftratio[2])+100);
		...
		TEXT_SetText(hItem,s);	
			...
			for(i=0;i<12;i++)//中心点在第10周期
			{
				...
				while(1)
				{
					...
					Wave[3]=ModuleComFaultbuf->Wave[3][i*64+n];
					GRAPH_DATA_YT_AddValue(ahData3U,Wave[3]/(Scale*ModuleComFaultbuf->fftratio[3])+100);
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		...
		//VoltageTemp=Voltage/100.0;
		VoltageTemp = ModuleComFaultbuf->RMSValue[4][1];
		Sort_D[0]=VoltageTemp;
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		...
		//VoltageTemp=Voltage/100.0;
		VoltageTemp = ModuleComFaultbuf->RMSValue[5][1];
		Sort_D[1]=VoltageTemp;
		VoltageTemp*=Setting.RatioStruct.RatioCT;
		//VoltageTemp=VoltageTemp/1000;
		VoltageTemp=(int32_t)(VoltageTemp*100)/100.0;
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		...
		//VoltageTemp=Voltage/100.0;
		VoltageTemp = ModuleComFaultbuf->RMSValue[6][1];
		Sort_D[2]=VoltageTemp;
		VoltageTemp*=Setting.RatioStruct.RatioCT;
		//VoltageTemp=VoltageTemp/1000;
		VoltageTemp=(int32_t)(VoltageTemp*100)/100.0;
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		*/
		...
		//VoltageTemp=Voltage/100;
		VoltageTemp = ModuleComFaultbuf->RMSValue[7][1];
		Sort_D[3]=VoltageTemp;
		/*
		VoltageTemp*=Setting.RatioStruct.RatioCT;
		//VoltageTemp=VoltageTemp/1000;
		 ...
		 for(i=0;i<12;i++)//中心点在第10周期
			{
				...
				while(1)
				{
					...
					Wave[4]=ModuleComFaultbuf->Wave[4][i*64+n];
					Wave[5]=ModuleComFaultbuf->Wave[5][i*64+n];
					Wave[6]=ModuleComFaultbuf->Wave[6][i*64+n];
						
					
					//GRAPH_DATA_YT_Clear(ahDataU0);	
					GRAPH_DATA_YT_AddValue(ahDataUA,Wave[4]/(Scale*ModuleComFaultbuf->fftratio[4])+100);				
					GRAPH_DATA_YT_AddValue(ahDataUB,Wave[5]/(Scale*ModuleComFaultbuf->fftratio[5])+100);				
					GRAPH_DATA_YT_AddValue(ahDataUC,Wave[6]/(Scale*ModuleComFaultbuf->fftratio[6])+100);
		...
		TEXT_SetText(hItem,s);	
			...
			for(i=0;i<12;i++)//中心点在第10周期
			{
				...
				while(1)
				{
					...
					Wave[7]=ModuleComFaultbuf->Wave[7][i*64+n];
					
					GRAPH_DATA_YT_AddValue(ahData3U,Wave[7]/(Scale*ModuleComFaultbuf->fftratio[7])+100);
  ...
  case WM_NOTIFY_PARENT:
    ...
    NCode = pMsg->Data.v;
		if(NCode==WM_NOTIFICATION_CLICKED)
		{
			...
			if(1 == SelectGndWaveOpen){
				GUI_EndDialog(WSGND_hWin,0);
					SelectGndWaveOpen=0;
