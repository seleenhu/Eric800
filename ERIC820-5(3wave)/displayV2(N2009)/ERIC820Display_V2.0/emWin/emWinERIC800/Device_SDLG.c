...
#define ID_TEXT_7     (GUI_ID_USER + 0x22)
#define ID_TEXT_8     (GUI_ID_USER + 0x23)
#define ID_TEXT_9     (GUI_ID_USER + 0x24)
#define ID_DROPDOWN_1     (GUI_ID_USER + 0x25)
#define ID_DROPDOWN_2     (GUI_ID_USER + 0x26)
#define ID_DROPDOWN_3     (GUI_ID_USER + 0x27)
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { TEXT_CreateIndirect, "BackLight", ID_TEXT_4, 190+291, 160, 103, 25, 0, 0x0, 0 },
  { DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_0, 331+291, 164, 140, 29, 0, 0x0, 0 },
  ...
  { TEXT_CreateIndirect, "selm/s", ID_TEXT_7, 190, 234, 103, 25, 0, 0x0, 0 },
  { DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_1, 331, 238, 140, 29, 0, 0x0, 0 },
  
  { TEXT_CreateIndirect, "selnum", ID_TEXT_8, 190+291, 234, 103, 25, 0, 0x0, 0 },
  { DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_2, 331+291, 238, 140, 29, 0, 0x0, 0 },
  
  { TEXT_CreateIndirect, "selm/s", ID_TEXT_9, 190, 308, 103, 25, 0, 0x0, 0 },
  { DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_3, 331, 312, 140, 29, 0, 0x0, 0 },
  //{ DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_3, 331+291, 238, 140, 29, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {
		...
		switch(SetType)
		{
			case 0:
				...
				SystemSet.Passwords[3] =Setting.Passwords[3];
				//SaveParam();
  ...
  case WM_INIT_DIALOG:
    ...
    hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_0);
		...
		passwords[0] = Setting.Passwords[0] + '0';
		passwords[1] = Setting.Passwords[1] + '0';
		passwords[2] = Setting.Passwords[2] + '0';
		passwords[3] = Setting.Passwords[3] + '0';
		passwords[4] = 0;
    EDIT_SetText(hItem, passwords);
		passwords[0] = 0;
		passwords[1] = 0;
		passwords[2] = 0;
		passwords[3] = 0;
	...
	DROPDOWN_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
    DROPDOWN_SetFont(hItem, &XBF_Font24);
    DROPDOWN_AddString(hItem, "主");
    DROPDOWN_AddString(hItem, "从");  
	
	if(Setting.SelMasterSlaveFlag){		
		DROPDOWN_SetSel(hItem,0);		
	}else{
		DROPDOWN_SetSel(hItem,1);
	}
		...
		DROPDOWN_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
		DROPDOWN_SetFont(hItem, &XBF_Font24);
		DROPDOWN_AddString(hItem, "0台");
		DROPDOWN_AddString(hItem, "1台");
		DROPDOWN_AddString(hItem, "2台");
		DROPDOWN_AddString(hItem, "3台"); 
		DROPDOWN_AddString(hItem, "4台"); 
		switch(Setting.SelSlaveNumSet){		
			case 1:
				DROPDOWN_SetSel(hItem,1);
				break;
			case 2:
			...
			case 4:
				...
				break;
			default:
				Setting.SelSlaveNumSet = 0;
				DROPDOWN_SetSel(hItem,0);
		}
	
		hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_9);
		TEXT_SetFont(hItem, &XBF_Font24);
		TEXT_SetText(hItem, "从机地址");
		TEXT_SetTextColor(hItem,GUI_WHITE);
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_DROPDOWN_1: // Notifications sent by 'keysound'
			  ...
			  case WM_NOTIFICATION_SEL_CHANGED:
				// USER START (Optionally insert code for reacting on notification message)
						...
						{
							case 0:
								Setting.SelMasterSlaveFlag=1;
								break;
							default:
								Setting.SelMasterSlaveFlag=0;
								break;
    ...
    case ID_DROPDOWN_2: // Notifications sent by 'safesound'
			  ...
			  case WM_NOTIFICATION_SEL_CHANGED:
				// USER START (Optionally insert code for reacting on notification message)
					if(1 == Setting.SelMasterSlaveFlag){				
						hItem=WM_GetDialogItem(pMsg->hWin,ID_DROPDOWN_2);
						switch(DROPDOWN_GetSel(hItem))
						{
							
							case 1:						
								SystemSet.SelSlaveNumSet = 1;
								break;
							case 2:
								SystemSet.SelSlaveNumSet =2;
								break;
							case 3:
								SystemSet.SelSlaveNumSet = 3;
								break;	
							case 4:
								SystemSet.SelSlaveNumSet = 4;
								break;
							default:
								SystemSet.SelSlaveNumSet = 0;
	  ...
	  case ID_DROPDOWN_3: // Notifications sent by 'safesound'
			  switch(NCode) {
			  case WM_NOTIFICATION_CLICKED:
				// USER START (Optionally insert code for reacting on notification message)
						if(NumPadOpen==1)
			  ...
			  case WM_NOTIFICATION_SEL_CHANGED:
				// USER START (Optionally insert code for reacting on notification message)
					if(0 == Setting.SelMasterSlaveFlag){
						hItem=WM_GetDialogItem(pMsg->hWin,ID_DROPDOWN_3);
						switch(DROPDOWN_GetSel(hItem))
						{
							case 0:
							...
							case 1:
								...
								SystemSet.RS485Set.adr = 2;
								break;
							case 2:
								SystemSet.RS485Set.adr =3;
								break;
							case 3:
								SystemSet.RS485Set.adr = 4;
								break;					
							default:
								SystemSet.RS485Set.adr = 1;
...
WM_HWIN CreateDevice_S(void) {
  ...
  DV_hWin = GUI_CreateDialogBox(_aDialogCreate, GUI_COUNTOF(_aDialogCreate), _cbDialog, WM_HBKWIN, 0, 0);
   hTimer =WM_CreateTimer(WM_GetClientWindow(DV_hWin),0,1000,0);
 (void)hTimer;
  return DV_hWin;
}
