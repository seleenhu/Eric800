...
//===============================参考电压
	 ...
	 for(n=0;n<MaxActionSave;n++)
	 {
		 ...
		 if(temp32==Cupboard_P[i][11].Id)
		 {
			 ...
			 temp8=ModuleComFaultbuf->FaultStyle;
			 switch(temp8)
			 {
				 case 0: //A相
					 sprintf(s1,"A %6.2f",ModuleComFaultbuf->RMSValue[0][1]);
					 break;
				 case 1://B相
					 sprintf(s1,"B %6.2f",ModuleComFaultbuf->RMSValue[1][1]);
					 break;
				 case 2://C相
					 sprintf(s1,"C %6.2f",ModuleComFaultbuf->RMSValue[2][1]);
					 break;
				 default:
					 sprintf(s1,"---");
					 break;
