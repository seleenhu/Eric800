...
void LoadParam(void)
{
	...
	if(PARAM_VER == SystemSet.ParamVer){		
		...
		SystemSet.NetSet.IPadrr[0] = 47;
		SystemSet.NetSet.IPadrr[1] = 98;
		SystemSet.NetSet.IPadrr[2] = 243;
		SystemSet.NetSet.IPadrr[3] = 193;		
		SystemSet.NetSet.Port = 8801;
		SystemSet.NetSet.Modbusadr = 0xBBFF;
		memcpy(SystemSet.NetSet.ModbudID,(void *)"ERIC0820190900000002",20);
