...
void bsp_InitExtSDRAM(void)
{
	...
	*/
	...
	FMC_SDRAMTimingInitStructure.FMC_SelfRefreshTime      = 5;//4;
	/* TRC:  min=70 (7x11.11ns or 11.90) */
	FMC_SDRAMTimingInitStructure.FMC_RowCycleDelay        = 8;//7;
...
static void SDRAM_GPIOConfig(void)
{
	...
	*/
	...
	GPIO_PinAFConfig(GPIOG, GPIO_PinSource2 , GPIO_AF_FMC);// Add for A12 by seleen 2018 07 03
	...
	//GPIO_InitStructure.GPIO_Pin = GPIO_PinSource4 | GPIO_Pin_5; 
