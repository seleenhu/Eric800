...
void bsp_InitSPIBus(void)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD, ENABLE);// add 2018 1 9
...
*/
	...
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource6, GPIO_AF5_SPI3);// GPIO_AF_SPI3);
	...
	GPIO_Init(GPIOD, &GPIO_InitStructure);	//PD6 SPI3_MOSI
