...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { BUTTON_CreateIndirect, "Voltag Limit Set", ID_BUTTON_10, 0, 265, 150, 39, 0, 0x0, 0 },
	...
	#ifdef EnableSyntonySet
	{ BUTTON_CreateIndirect, "Device Set", ID_BUTTON_14, 0, 425, 150, 39, 0, 0x0, 0 },
	#endif
  { EDIT_CreateIndirect, "Edit", ID_EDIT_0, 340, 170, 80, 30, 0, 0x64, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {
		case WM_SetValue:
		/*	
		Setting.LeakageCurrentSet.LeakageValue=LeakageCurrent;
		g_tParam.LeakageCurrentMax=LeakageCurrent;
		*/
		Setting.ShortGNDSet.I0=LeakageCurrent;
		//g_tParam.ShortI0=LeakageCurrent;
		//SaveParam();
		SystemSet.ShortGNDSet.I0 = LeakageCurrent;
  ...
  case WM_PAINT:
    ...
    //GUI_SetFont(GUI_FONT_20B_ASCII);
		GUI_SetFont(&XBF_Font24);
    //GUI_DispStringAt("漏电流上限",180,170);
		GUI_DispStringAt("零序电流设置",180,170);

    GUI_DispStringAt("A",450,170);
  ...
  case WM_INIT_DIALOG:
    ...
    hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_0);
	  ...
	  //f=g_tParam.LeakageCurrentMax;
		f=Setting.ShortGNDSet.I0;
		sprintf(s,"%6.2f",f);
      ...
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
			  ...
			  EDIT_GetText(hItem,Buffer,10);
				LeakageCurrent=atof(Buffer);//读初始值
...
*/
WM_HWIN CreateLeakageCurrent_S(void);
WM_HWIN CreateLeakageCurrent_S(void) {
  //WM_HWIN hWin;

  LC_hWin = GUI_CreateDialogBox(_aDialogCreate, GUI_COUNTOF(_aDialogCreate), _cbDialog, WM_HBKWIN, 0, 0);
  return LC_hWin;
}
