...
static const GUI_WIDGET_CREATE_INFO _aDialogCreateNumPad[] = {
  { WINDOW_CreateIndirect, "NumPad", ID_WINDOW_0, 550, 130, 200, 340, 0, 0x0, 0 },
								 ...
								 if(Id==GUI_ID_USER+16)
								 {
									...
									{		
										...
										case 5:
											...
											break;
										case 6:
											WM_SendMessageNoPara(WM_GetClientWindow(DV_hWin), WM_SetValue); //向通用设置界面发 WM_SetValue  消息
											break;
										case 7:
											WM_SendMessageNoPara(WM_GetClientWindow(PS_hWin), WM_SetValue); //向密码界面发 WM_SetValue  消息
											break;
										case 8:
											WM_SendMessageNoPara(WM_GetClientWindow(SY_hWin), WM_SetValue); //向谐振界面发 WM_SetValue  消息
											break;
										default:
											break;
									}
