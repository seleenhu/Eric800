...
void LoadParam(void)
{
	...
	if(PARAM_VER == SystemSet.ParamVer){		
		...
		SystemSet.NetSet.IPadrr[0] = 113;
		SystemSet.NetSet.IPadrr[1] = 116;
		SystemSet.NetSet.IPadrr[2] = 159;
		SystemSet.NetSet.IPadrr[3] = 89;		
		SystemSet.NetSet.Port = 10011;
		SystemSet.NetSet.Modbusadr = 0xBBFF;
		memcpy(SystemSet.NetSet.ModbudID,(void *)"ERIC0800180900000002",20);
...
//=====================
		...
		Setting.Passwords[0]=0;
		Setting.Passwords[1]=0;
		Setting.Passwords[2]=0;
		Setting.Passwords[3]=0;
