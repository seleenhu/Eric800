...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { BUTTON_CreateIndirect, "Voltag Limit Set", ID_BUTTON_10, 0, 300, 150, 43, 0, 0x0, 0 },
	...
	#endif
  { EDIT_CreateIndirect, "Edit", ID_EDIT_0, 428, 170, 120, 30, 0, 0x64, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
	...
	GUI_DispStringAt("故障零序电流上限设置",180,170);

    GUI_DispStringAt("A",556,170);
...
WM_HWIN CreateLeakageCurrent_S(void) {
  ...
  hTimer =WM_CreateTimer(WM_GetClientWindow(LC_hWin),0,1000,0);
 (void)hTimer;
  return LC_hWin;
}
