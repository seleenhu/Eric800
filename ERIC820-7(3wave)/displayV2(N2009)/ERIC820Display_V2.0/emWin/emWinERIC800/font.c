...
#define   XBF_Font14BaseAdd    0x00000000
GUI_XBF_DATA XBF_Data14;
GUI_FONT     XBF_Font14;
void         *Fontfile14;	
	
	
#define   XBF_Font16BaseAdd    0x0013F8C0
GUI_XBF_DATA XBF_Data16;
GUI_FONT     XBF_Font16;
void         *Fontfile16;
	
#define   XBF_Font20BaseAdd    0x0029B076
GUI_XBF_DATA XBF_Data20;
GUI_FONT     XBF_Font20;
void         *Fontfile20;	

/* 宋体24点阵定义 */
#define   XBF_Font24BaseAdd    0x004BA988
GUI_XBF_DATA XBF_Data24;
GUI_FONT     XBF_Font24;
void         *Fontfile24;

/* 宋体32点阵定义 */
#define   XBF_Font32BaseAdd    0x0072E136
...
{	
	/* 读取点阵数据 */
	sf_ReadBuffer(pBuffer, XBF_Font14BaseAdd + Off, NumBytes);
	return 0;
}
...
void GUI_SetXBF(void) 
{
	...
	/* 创建14点阵字体 */
	GUI_XBF_CreateFont(&XBF_Font14,        /* GUI_FONT类型变量     */
					 &XBF_Data14,          /* GUI_XBF_DATA类型变量 */
