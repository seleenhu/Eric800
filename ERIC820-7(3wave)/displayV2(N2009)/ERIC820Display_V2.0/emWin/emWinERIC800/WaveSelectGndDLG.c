...
uint8_t  SelectGndWave;
uint8_t  SelectGndWaveOpen;
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "WaveSelect", ID_FRAMEWIN_0, 430, 180-47, 130, 243, 0, 0x0, 0 },
  ...
  { BUTTON_CreateIndirect, "VectorW", ID_BUTTON_3, 2, 143, 120, 45, 0, 0x0, 0 },
	{ BUTTON_CreateIndirect, "FaultWave", ID_BUTTON_4, 2, 190, 120, 45, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_3: // Notifications sent by 'VectorW'
	  ...
	  break;
	   case ID_BUTTON_4: // Notifications sent by 'VectorW'
		  switch(NCode) {
		  case WM_NOTIFICATION_CLICKED:
			// USER START (Optionally insert code for reacting on notification message)
...
*       CreateWaveSelect
*/
WM_HWIN CreateGndWaveSelect(void);
WM_HWIN CreateGndWaveSelect(void) {
 // WM_HWIN hWin;
  WM_HTIMER hTimer;
  WSGND_hWin = GUI_CreateDialogBox(_aDialogCreate, GUI_COUNTOF(_aDialogCreate), _cbDialog, WM_HBKWIN, 0, 0);
  hTimer =WM_CreateTimer(WM_GetClientWindow(WSGND_hWin),0,1000,0);
  (void)hTimer;
  return WSGND_hWin;
}
