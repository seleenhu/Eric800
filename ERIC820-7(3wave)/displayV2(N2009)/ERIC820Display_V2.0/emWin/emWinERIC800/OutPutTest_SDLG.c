...
#define ID_TEXT_3      (GUI_ID_USER + 0x1B)
...
#define ID_TEXT_10      (GUI_ID_USER + 0x28)
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { TEXT_CreateIndirect, "C Phase", ID_TEXT_2, 500, 80, 80, 30, 0, 0x64, 0 },
	...
	{ BUTTON_CreateIndirect, "D_On", ID_BUTTON_18, 630, 110, 80, 40, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "D_Off", ID_BUTTON_19, 630, 160, 80, 40, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "C Phase", ID_TEXT_10, 640, 80, 80, 30, 0, 0x64, 0 },
  ...
  { TEXT_CreateIndirect, "OnoffStatus", ID_TEXT_3, 210, 240, 160, 30, 0, 0x64, 0 },
	...
	{ BUTTON_CreateIndirect, "", ID_BUTTON_25, 620, 400, 40, 30, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "", ID_BUTTON_26, 660, 400, 40, 30, 0, 0x0, 0 },
	{ TEXT_CreateIndirect, "TestStatus", ID_TEXT_6, 710, 400, 50, 30, 0, 0x64, 0 },
	{ BUTTON_CreateIndirect, "", ID_BUTTON_27, 620, 440, 40, 30, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "", ID_BUTTON_28, 660, 440, 40, 30, 0, 0x0, 0 },
	{ TEXT_CreateIndirect, "DistanceStatus", ID_TEXT_7, 710, 440, 50, 30, 0, 0x64, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {
		...
		//====D 相合闸开闸指示
		if(SystemState.SwitchState.phaseAction&0x08)
		GUI_SetColor(GUI_RED);
		else
		GUI_SetColor(GUI_GRAY);
		//GUI_SetColor(GUI_YELLOW);
		GUI_FillCircle(670,300,25);
  ...
  case WM_INIT_DIALOG:
   ...
   // TEXT_SetTextColor(hItem, GUI_MAKE_COLOR(0x000080FF));
    ...
    BUTTON_SetText(hItem, "分闸");
    //
    // Initialization of 'D Phase'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_10);
    TEXT_SetFont(hItem, &XBF_Font24);
   // TEXT_SetTextColor(hItem, GUI_MAKE_COLOR(0x000080FF));
    TEXT_SetText(hItem, "D 相");
    //
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_17: // Notifications sent by 'C_Off'
      ...
      break;
		...
		case ID_BUTTON_18: // Notifications sent by 'D_On'
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
			if(0 != PutOP_LED_STATE()) //投运不处理
      ...
      break;
    case ID_BUTTON_19: // Notifications sent by 'C_Off'
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
			if(0 != PutOP_LED_STATE()) //投运不处理
