...
#define   SiliconControl_ON()		 GPIO_SetBits(GPIOH, GPIO_Pin_9)
#define   SiliconControl_OFF()		 GPIO_ResetBits(GPIOH, GPIO_Pin_9)
#define   SiliconControl_XOR()		 GPIO_ToggleBits(GPIOH, GPIO_Pin_9)


extern uint8_t SiliconControl_flag;
...
extern uint8_t GndPhase2HourFlag;
extern uint32_t GndPhase2HourCount;
