...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    	...
    	GUI_DrawLine(590,105,600,100);
			...
			Sort_D[0]=SDSuddentAlarmData->RMSValue[0][1]*SDSuddentAlarmData->VabuleSin[0][1];
			Sort_D[1]=SDSuddentAlarmData->RMSValue[1][1]*SDSuddentAlarmData->VabuleSin[1][1];
			Sort_D[2]=SDSuddentAlarmData->RMSValue[2][1]*SDSuddentAlarmData->VabuleSin[2][1];
			Scale=sort(Sort_D,3)/80;
			//=======UA
			temp=SDSuddentAlarmData->RMSValue[0][1];
			tempY=temp*SDSuddentAlarmData->VabuleSin[0][1];
			tempY*=Scale;
			tempX=temp*SDSuddentAlarmData->VabuleCos[0][1];
			tempX*=Scale;
			GUI_SetColor(GUI_YELLOW);
    	GUI_SetPenSize(2);
			GUI_DrawLine(400,100,400+tempX,100+tempY);
			//========UB
			temp=SDSuddentAlarmData->RMSValue[1][1];
			tempY=temp*SDSuddentAlarmData->VabuleSin[1][1];
			tempY*=Scale;
			tempX=temp*SDSuddentAlarmData->VabuleCos[1][1];
			tempX*=Scale;
			GUI_SetColor(GUI_GREEN);
    	GUI_SetPenSize(2);
			GUI_DrawLine(400,100,400+tempX,100+tempY);
			//==========UC
			temp=SDSuddentAlarmData->RMSValue[2][1];
			tempY=temp*SDSuddentAlarmData->VabuleSin[2][1];
			tempY*=Scale;
			tempX=temp*SDSuddentAlarmData->VabuleCos[2][1];
			tempX*=Scale;
			GUI_SetColor(GUI_RED);
    	GUI_SetPenSize(2);
			GUI_DrawLine(400,100,400+tempX,100+tempY);
