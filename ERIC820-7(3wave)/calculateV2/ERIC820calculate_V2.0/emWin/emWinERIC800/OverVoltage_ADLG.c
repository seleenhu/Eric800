...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { TEXT_CreateIndirect, "Ua=10.00          KV", ID_TEXT_2, 220, 94, 200, 20, 0, 0x0, 0  },
  { TEXT_CreateIndirect, "Ub=10.00          KV", ID_TEXT_3, 420, 94, 200, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Uc=10.00          KV", ID_TEXT_4, 620, 94, 200, 20, 0, 0x0, 0 },
 // { TEXT_CreateIndirect, "3U0=0.25          KV", ID_TEXT_5, 425, 200, 200, 25, 0, 0x0, 0 },
	...
	{ BUTTON_CreateIndirect, "Select", ID_BUTTON_25, 430, 380, 130, 45, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {
    ...
    break;
		case 3:
		TEXT_SetText(hItem,"AB相过电压");
		break;
		case 5:
		TEXT_SetText(hItem,"AC相过电压");
		break;
		case 6:
		TEXT_SetText(hItem,"BC相过电压");
		break;
		case 7:
		TEXT_SetText(hItem,"ABC相过电压");
		break;
		default:
		break;
		}
...
WM_HWIN CreateOverVoltage_A(void) {
  ...
  VA_hWin = GUI_CreateDialogBox(_aDialogCreate, GUI_COUNTOF(_aDialogCreate), _cbDialog, WM_HBKWIN, 0, 0);
	hTimer =WM_CreateTimer(WM_GetClientWindow(VA_hWin),0,100,0);
  (void)hTimer;
  return VA_hWin;
}
