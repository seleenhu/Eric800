...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { BUTTON_CreateIndirect, "", ID_BUTTON_10, 0, 265, 150, 39, 0, 0x0, 0 },
	...
	#ifdef EnableSyntonySet
	{ BUTTON_CreateIndirect, "Synotony Set", ID_BUTTON_14, 0, 425, 150, 39, 0, 0x0, 0 },
	#endif
  { EDIT_CreateIndirect, "Edit", ID_EDIT_0, 350, 170, 80, 30, 0, 0x64, 0 },
	//{ EDIT_CreateIndirect, "Edit", ID_EDIT_1, 350, 250, 80, 25, 0, 0x64, 0 },
	{ DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_0, 350, 250, 80, 30, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {
	case WM_SetValue:
		...
		{
			case 0:
			Setting.VoltageSet.Modulus=VoltageLimit;
			//g_tParam.Modulus=VoltageLimit;
			//SaveParam();
			SystemSet.ParamSaveFlag = 1;
			//=======计算报警电压最大最小值
			...
			break;
			case 1:
			Setting.VoltageSet.MaxRatedValue=RatedVoltage;
			//g_tParam.MaxRatedValue=RatedVoltage;
			//SaveParam();
			SystemSet.ParamSaveFlag = 1;
			//=======计算报警电压最大最小值
			//Setting.ADCUCompSet.MaxValue=CalculateMaxVoltage();
  ...
  case WM_PAINT:
    ...
    //GUI_SetFont(GUI_FONT_20B_ASCII);
		GUI_SetFont(&XBF_Font24);
    GUI_DispStringAt("过电压门限系数",180,170);

    GUI_DispStringAt("倍",430,170);
		
		GUI_DispStringAt("一次额定电压",180,250);

    GUI_DispStringAt("KV",430,250);
  ...
  case WM_INIT_DIALOG:
    ...
    hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_0);
		...
		sprintf(s,"%6.1f",Setting.VoltageSet.Modulus);
		EDIT_SetText(hItem, s);
    //EDIT_SetText(hItem, "2.0");
    EDIT_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
	  #if 0
		hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_1);
		EDIT_SetFont(hItem, GUI_FONT_20B_ASCII);
		sprintf(s,"%6.1f",g_tParam.MaxRatedValue);
		EDIT_SetText(hItem, s);
    //EDIT_SetText(hItem, "10000.0");
    EDIT_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
		#endif
    ...
    // USER START (Optionally insert additional code for further Ids)
      ...
      case WM_NOTIFICATION_SEL_CHANGED:
        // USER START (Optionally insert code for reacting on notification message)
				...
				{
					case 0:
						Setting.VoltageSet.MaxRatedValue=6000;
						break;
					case 1:
						Setting.VoltageSet.MaxRatedValue=10000;
						break;
					case 2:
						Setting.VoltageSet.MaxRatedValue=20000;
						break;
					case 3:
						Setting.VoltageSet.MaxRatedValue=35000;
						break;
					case 4:
						Setting.VoltageSet.MaxRatedValue=66000;
						break;
					default:
						Setting.VoltageSet.MaxRatedValue=10000;
						break;
				...
				//GUI_Delay(5);
				//g_tParam.MaxRatedValue=Setting.VoltageSet.MaxRatedValue;
				//SaveParam();
				SystemSet.ParamSaveFlag = 1;
        // USER END
        break;
...
*       CreateLeakageCurrent_S
*/
WM_HWIN CreateVoltageLimit_S(void);
WM_HWIN CreateVoltageLimit_S(void) {
  //WM_HWIN hWin;

  VL_hWin = GUI_CreateDialogBox(_aDialogCreate, GUI_COUNTOF(_aDialogCreate), _cbDialog, WM_HBKWIN, 0, 0);
  return VL_hWin;
}
