  ...
  switch (pMsg->MsgId) {
	case WM_SetValue:
		switch(SetType)
		{
			...
			SystemSet.VoltageSet.Modulus=VoltageLimit;
			...
			//SaveParam();
			SystemSet.VoltageSet.MaxRatedValue=VoltageLimit;
			SystemSet.ParamSaveFlag = FlagSystemState;
			//=======计算报警电压最大最小值
			//Setting.ADCUCompSet.MaxValue=CalculateMaxVoltage();
			//Setting.ADCUCompSet.MinValue=-CalculateMaxVoltage();
  ...
  case WM_INIT_DIALOG:
    ...
    //
     hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_0);
		...
		sprintf(s,"%6.1f",SystemSet.VoltageSet.Modulus);
    ...
    //DROPDOWN_SetAutoScroll(hItem,1);
		...
		switch(SystemSet.VoltageSet.MaxRatedValue)
		{
			case 6000:
	...
	case ID_DROPDOWN_0: // Notifications sent by 'Dropdown'
      ...
      case WM_NOTIFICATION_SEL_CHANGED:
        // USER START (Optionally insert code for reacting on notification message)
				...
				//SaveParam();
				SystemSet.VoltageSet.MaxRatedValue = Setting.VoltageSet.MaxRatedValue;
				SystemSet.ParamSaveFlag = FlagSystemState;
        // USER END
        break;
      // USER START (Optionally insert additional code for further notification handling)
