...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { BUTTON_CreateIndirect, "Voltag Limit Set", ID_BUTTON_10, 0, 265, 150, 39, 0, 0x0, 0 },
	...
	#endif
  { EDIT_CreateIndirect, "Temprature_H", ID_EDIT_0, 350, 125, 120, 35, 0, 0x64, 0 },
  { EDIT_CreateIndirect, "Temprature_L", ID_EDIT_1, 350, 175, 120, 35, 0, 0x64, 0 },
  { EDIT_CreateIndirect, "Humdity_H", ID_EDIT_2, 350, 225, 120, 35, 0, 0x64, 0 },
  { EDIT_CreateIndirect, "Humdity_L", ID_EDIT_3, 350, 275, 120, 35, 0, 0x64, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    GUI_DispStringAt("Temperature High",240,130);
*/
		GUI_SetFont(&XBF_Font24);
		GUI_DispStringAt("温度上限",240,130);
		GUI_DispStringAt("℃",470,130);
		
    GUI_SetColor(GUI_GREEN);
		/*
    GUI_SetFont(GUI_FONT_20B_ASCII);
    GUI_DispStringAt("Temperature Low",240,180);
		*/
		GUI_DispStringAt("温度下限",240,180);
		GUI_DispStringAt("℃",470,180);

    GUI_SetColor(GUI_RED);
    //GUI_SetFont(GUI_FONT_20B_ASCII);
    //GUI_DispStringAt("Humidity High",240,230);
		GUI_DispStringAt("湿度上限",240,230);
		GUI_DispStringAt("%RH",470,230);

    GUI_SetColor(GUI_GREEN);
    //GUI_SetFont(GUI_FONT_20B_ASCII);
    //GUI_DispStringAt("Humidity Low",240,280);
		GUI_DispStringAt("湿度下限",240,280);
		GUI_DispStringAt("%RH",470,280);
      break;
