...
//
	...
	for(m=0;m<20;m++)
	{
		for(k=0;k<12;k++)
		{
			...
			//======
				...
				Cupboard_P[m][k].Value.ProtectorData.OverVoltageHA=120;
				Cupboard_P[m][k].Value.ProtectorData.OverVoltageHB=120;
				Cupboard_P[m][k].Value.ProtectorData.OverVoltageHC=120;
				Cupboard_P[m][k].Value.ProtectorData.OverVoltageTA=30000;
				Cupboard_P[m][k].Value.ProtectorData.OverVoltageTB=30000;
				Cupboard_P[m][k].Value.ProtectorData.OverVoltageTC=30000;
				Cupboard_P[m][k].Value.HumdityCupboard=120;
				Cupboard_P[m][k].Value.TempCupboard=30000;
				Cupboard_P[m][k].Value.TempBusA=30000;
				Cupboard_P[m][k].Value.TempBusB=30000;
				Cupboard_P[m][k].Value.TempBusC=30000;
				Cupboard_P[m][k].Value.TempTouchDownA=30000;
				Cupboard_P[m][k].Value.TempTouchDownB=30000;
				Cupboard_P[m][k].Value.TempTouchDownC=30000;
				Cupboard_P[m][k].Value.TempTouchUpA=30000;
				Cupboard_P[m][k].Value.TempTouchUpB=30000;
				Cupboard_P[m][k].Value.TempTouchUpC=30000;
	...
	//=========Load system setting
	  ...
	  Setting.TempSet.MinValue=g_tParam.TempMin;
		...
		Setting.LeakageCurrentSet.LeakageValue=g_tParam.LeakageCurrentMax;
