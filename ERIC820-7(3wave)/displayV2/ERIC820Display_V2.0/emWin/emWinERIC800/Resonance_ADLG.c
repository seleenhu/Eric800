...
#define ID_TEXT_20  (GUI_ID_USER + 0x1c)
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { BUTTON_CreateIndirect, "Next", ID_BUTTON_11, 240, 380, 130, 45, 0, 0x0, 0 },
	...
	{ BUTTON_CreateIndirect, "ProtectData", ID_BUTTON_31, 620, 380,130, 45, 0, 0x0, 0 },
  ...
  { TEXT_CreateIndirect, "", ID_TEXT_19, 472, 225+40, 82, 25, 0, 0x64, 0 },
	...
	{ TEXT_CreateIndirect, "", ID_TEXT_0, 20, 94, 180, 25, 0, 0x0, 0 },
  //{ TEXT_CreateIndirect, "", ID_TEXT_1, 175, 120, 147, 25, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "", ID_TEXT_2, 20, 60, 400, 25, 0, 0x0, 0 },
  ...
  { TEXT_CreateIndirect, "", ID_TEXT_4, 430, 160, 150, 20, 0, 0x0, 0 },
	...
	{ TEXT_CreateIndirect, "", ID_TEXT_10, 220, 94, 200, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "", ID_TEXT_11, 420, 94, 200, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "", ID_TEXT_12, 620, 94, 200, 20, 0, 0x0, 0 },
	//=====displaytime
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  break;	
    ...
    //TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		...
		{
		case 1:
		TEXT_SetText(hItem,"A相系统过电压");
		break;
		case 2:
		TEXT_SetText(hItem,"B相系统过电压");
		break;
		case 4:
		TEXT_SetText(hItem,"C相系统过电压");
    break;
		case 3:
		TEXT_SetText(hItem,"AB相系统过电压");	
			break;
		case 5:
		TEXT_SetText(hItem,"AC相系统过电压");	
			break;
	  case 6:
		TEXT_SetText(hItem,"BC相系统过电压");	
			break;
		case 7:
		TEXT_SetText(hItem,"ABC相系统过电压");	
			break;
		default:
		break;
		}
    ...
    TEXT_SetTextColor(hItem, GUI_WHITE);
		 */
		Voltage=ModuleComFaultbuf->RMSValue[3][1];
		VoltageTemp=Voltage;
    ...
    TEXT_SetTextColor(hItem, GUI_WHITE);
		...
		*/
		...
		Voltage=ModuleComFaultbuf->RMSValue[4][1];
		VoltageTemp=Voltage;
    ...
    //
		...
		Voltage=ModuleComFaultbuf->RMSValue[5][1];
		VoltageTemp=Voltage;
    ...
    //
		...
		Voltage=ModuleComFaultbuf->RMSValue[6][1];
		VoltageTemp=Voltage;
...
WM_HWIN CreateResonance_A(void) {
  ...
  RA_hWin = GUI_CreateDialogBox(_aDialogCreate, GUI_COUNTOF(_aDialogCreate), _cbDialog, WM_HBKWIN, 0, 0);
	hTimer =WM_CreateTimer(WM_GetClientWindow(RA_hWin),0,100,0);
 (void)hTimer;
  return RA_hWin;
}
