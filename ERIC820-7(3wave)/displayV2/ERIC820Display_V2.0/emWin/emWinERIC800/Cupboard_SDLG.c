...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { EDIT_CreateIndirect, "Edit", ID_EDIT_0, 310+74, 240, 200-74, 35, 0, 0x64, 0 },
  { BUTTON_CreateIndirect, "Button", ID_BUTTON_15, 580, 420, 110, 46, 0, 0x0, 0 },
	{ DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_3, 310, 240, 64, 30, 0, 0x0, 0 },
	{ EDIT_CreateIndirect, "Edit", ID_EDIT_1, 310, 380, 200, 35, 0, 0x64, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
	...
	DROPDOWN_SetFont(hItem, &XBF_Font24);
    DROPDOWN_SetListHeight(hItem, 140);
	DROPDOWN_SetScrollbarWidth(hItem,30);
	DROPDOWN_SetTextHeight(hItem, 30);
	DROPDOWN_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
	DROPDOWN_SetAutoScroll(hItem,1);	
...
#else	
		SensorId=Cupboard_P[CupboardIndex][DetailsIndex].Id;
		RF433Id = SensorId&0x00ffffff;
		sprintf(s,"%d",SensorId&0x00ffffff);
		RF433IdType = SensorId>>24;
		hItem = WM_GetDialogItem(pMsg->hWin, ID_DROPDOWN_3);
		switch(SensorId>>24){			
			case 'B':
				//sprintf(s+len,".2");
	...
	if((0 == SystemSet.CupboardSIZE)||(SystemSet.CupboardSIZE>20)){
		SystemSet.CupboardSIZE = 20;
	}
	Cupboard_sizef = SystemSet.CupboardSIZE;
	sprintf(s,"%d",SystemSet.CupboardSIZE);
    EDIT_SetText(hItem, s);
    EDIT_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
    EDIT_SetFont(hItem, GUI_FONT_24B_ASCII);
...
#if			0				
				RF433Idf = atof(Buffer);
				RF433Id = RF433Idf*10;
				RF433IdType = RF433Id%10;
				RF433Id /= 10;
				switch(RF433IdType){
					case 2:
						RF433IdType = 'B';
    ...
    case ID_BUTTON_15: // Notifications sent by 'Button' 确定
      ...
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
				if(DetailsIndex<11)
				{	
				Cupboard_P[CupboardIndex][DetailsIndex].Id=RF433Id|(RF433IdType<<24);				
				//g_tParam.CupboardID[CupboardIndex][DetailsIndex]=RF433Id|('A'<<24);
				SystemSet.CupboardID[CupboardIndex][DetailsIndex]=RF433Id|(RF433IdType<<24);
				}
				else
				{
				...
				SystemSet.CupboardSIZE = Cupboard_sizef;
				if(0 == SystemSet.CupboardSIZE){
					SystemSet.CupboardSIZE = 1;
				}else if(SystemSet.CupboardSIZE>20){
					SystemSet.CupboardSIZE = 20;
				}
...
WM_HWIN CreateCupboard_S(void) {
  ...
  hTimer =WM_CreateTimer(WM_GetClientWindow(CB_hWin),0,1000,0);
 (void)hTimer;
  return CB_hWin;
}
