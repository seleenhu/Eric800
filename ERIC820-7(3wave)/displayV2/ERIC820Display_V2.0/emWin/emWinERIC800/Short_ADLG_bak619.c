...
static void _cbButton8(WM_MESSAGE * pMsg)
{
	...
	switch (pMsg->MsgId)
	{
		case WM_PAINT:
			...
			*/
			GUI_SetFont(&XBF_Font24);
			GUI_DispStringInRect("谐振告警", &Rect, GUI_TA_LEFT | GUI_TA_VCENTER);
			break;
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {
    ...
    //TEXT_SetFont(hItem, GUI_FONT_20B_ASCII);
		...
		{
		case 1:
		TEXT_SetText(hItem,"A相接地");
		break;
		case 2:
		TEXT_SetText(hItem,"B相接地");
		break;
		case 4:
		TEXT_SetText(hItem,"C相接地");
    break;
		default:
		break;
		}
		 ...
		 for(i=6;i<18;i++)//中心点在第10周期
			{
				...
				while(1)
				{
					...
					Wave[3]=*(u8 *)(SDAlarm_SDRAM+S_VoltageDataOffset+i*512+30720+2*n);
					Wave[3]+=(*(u8 *)(SDAlarm_SDRAM+S_VoltageDataOffset+i*512+30720+2*n+1))<<8;
					
					
					GRAPH_DATA_YT_AddValue(ahDataUA,Wave[0]/200+90);
				
					GRAPH_DATA_YT_AddValue(ahDataUB,Wave[1]/200+90);
				
					GRAPH_DATA_YT_AddValue(ahDataUC,Wave[2]/200+90);
					n+=4;
					if(n>=256)
					break;
...
//==================================================================
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_10: // Notifications sent by 'Up'
      ...
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
				if(SA_WavePosition>=(AlarmSaCount-1))
				{
					break;
				}
				SA_WavePosition++;
